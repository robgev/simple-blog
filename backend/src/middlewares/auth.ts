...
export const authorizeCommentChange = async (req: Request, res: Response, next: NextFunction) => {
...
export const authorizePostChange = async (req: Request, res: Response, next: NextFunction) => {
  const user = (res.locals.user as TUser)
  const { id } = req.params
